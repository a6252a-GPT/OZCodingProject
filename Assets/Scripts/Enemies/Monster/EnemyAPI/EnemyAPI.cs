////// 전찬우삭제 - 기존 EnemyApi는 MonsterInteractionApi로 대체했습니다.
////// 전찬우삭제 - 파일은 삭제하지 않고 기존 코드를 아래에 보존 주석으로 남깁니다.
////// 전찬우삭제 - 새 코드에서는 EnemyApi를 직접 호출하지 말고 MonsterInteractionApi를 사용합니다.
